...
class report_session_list_adapter(var data: ArrayList<sessionIdAndNameData_Object>): RecyclerView.Adapter<report_session_list_adapter.ViewHolder>() {
    ...
    inner class ViewHolder(var binding:ReportSessionListItemBinding):RecyclerView.ViewHolder(binding.root){

...
class presenty_showing_RecyclerView_adapter(var data:ArrayList<data_attendance_report_show_object>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(PresentyShowItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.onBind(data[position])
    }
    inner class ViewHolder(var binding:PresentyShowItemBinding):RecyclerView.ViewHolder(binding.root)
    {
    ...
    fun updateStatusColor(binding: PresentyShowItemBinding)
    {
        ...
        {
            binding.presentyShowingPresentyStatus.setTextColor(ContextCompat.getColor(binding.root.context, R.color.green))
        }
        else
        {
            binding.presentyShowingPresentyStatus.setTextColor(ContextCompat.getColor(binding.root.context, R.color.red))
        }
    }
